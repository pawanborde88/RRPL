...
@Component({
  selector: 'app-all-revisit-enquiry-report',
  standalone: true,
  imports: [
    CommonModule,
    RouterModule,
  ...
  templateUrl: './all-revisit-enquiry-report.component.html',
  styleUrl: './all-revisit-enquiry-report.component.scss',
})
export class AllRevisitEnquiryReportComponent {
