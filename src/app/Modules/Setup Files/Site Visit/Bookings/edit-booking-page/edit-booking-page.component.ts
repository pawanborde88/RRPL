        ...
        next: (res: any) => {
          if (res) {
            ...
            const patchData = {
              ...
              maintanace_gst: res.maintanace_gst || null,
              corpus: res.corpus_fund || null,
              clubhouse_amount: res.clubhouse_amount || null,
              clubhouse_gst: res.clubhouse_gst || null,
        ...
        next: (res: any) => {
          if (res.success) {
            ...
            this.addBookingForm.patchValue({
              ...
              idc_gst: bookingData.idc_gst ?? null,
              ...
              maintanace_gst: bookingData.maintanace_gst ?? null,
              corpus: bookingData.corpus ?? null,
              clubhouse_amount: bookingData.clubhouse_amount ?? null,
              clubhouse_gst: bookingData.clubhouse_gst ?? null,
