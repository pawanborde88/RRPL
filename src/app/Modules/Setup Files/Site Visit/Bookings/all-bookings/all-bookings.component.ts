...
export class AllBookingsComponent implements OnInit {
    ...
    readonly bookingDisplayedColumns: BookingColumn[] = [
        ...
        { key: 'idc_gst', label: 'IDC GST', isAmount: true },
        ...
        { key: 'maintanace_gst', label: 'Maintenance GST', isAmount: true },
        { key: 'corpus', label: 'Corpus', isAmount: true },
        { key: 'clubhouse_amount', label: 'Clubhouse Amount', isAmount: true },
        { key: 'clubhouse_gst', label: 'Clubhouse GST', isAmount: true },
