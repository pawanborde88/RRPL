...
import { AddFaceBookComponent } from '../../../Facebook Setup/add-face-book/add-face-book.component';
import { AddEditDigitalFacebookDialog } from '../../add-edit-digital-facebook-dialog/add-edit-digital-facebook-dialog';
...
export class DigitalAllFacebookBudget implements OnInit {
  ...
  openaddFacebookDialog(): void {
    const dialogRef = this.dialog.open(AddEditDigitalFacebookDialog, {
      width: '600px',
  ...
  deleteFaceBookID(projectEnquiryID: any): void {
    const dialogRef = this.dialog.open(ConfirmDialogComponent, {
      minWidth: '25vw',
      data: { message: 'Are you sure you want to delete Facebook Budget?' },
    });
    ...
    dialogRef.afterClosed()
      ...
      .subscribe((result) => {
        if (result) {
          ...
          let requestPayload = {
            project_budget_setup_id: projectEnquiryID,
