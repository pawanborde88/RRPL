...
export interface BookingData {
  ...
  applicant_name4?: string;
  applicant_current_address?: string;
  coapplicant_current_address?: string;
  applicant3_current_address?: string;
  applicant4_current_address?: string;
  applicant_dob?: string;
  coapplicant_dob?: string;
  applicant3_dob?: string;
  applicant4_dob?: string;
  applicant_pan_no?: string;
  coapplicant_pan_no?: string;
  applicant3_pan_no?: string;
  applicant4_pan_no?: string;
  applicant_aadhar_no?: string;
  coapplicant_aadhar_no?: string;
  applicant3_aadhar_no?: string;
  applicant4_aadhar_no?: string;
  applicant_email?: string;
  srg_total?: any;
  mc_total?: any;

  coapplicant_email?: string;
  applicant3_email?: string;
  applicant4_email?: string;
  applicant_mobile?: string;
  coapplicant_mobile?: string;
  applicant3_mobile?: string;
  applicant4_mobile?: string;
  applicant_occupation?: string;
  coapplicant_occupation?: string;
  applicant3_occupation?: string;
  applicant4_occupation?: string;
  applicant_age?: string;
  coapplicant_age?: string;
  applicant3_age?: string;
  applicant4_age?: string;
  ...
  home_loan_doc_submission_date?: string;
  tax_payment_completion_date?: string;
  own_contribution_payment_date?: string;
  agreement_completion_date?: string;
  disbursement_completion_date?: string;
  floor_units?: {
